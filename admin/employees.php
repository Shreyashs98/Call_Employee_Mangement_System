    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                <div class="logo">
                    <a href="dashboard.php"><img src="../assets/images/icon/logo.jpg" alt="logo">Call Center EMS</a>
                </div>
            </div>
            <div class="main-menu">
                        ...
                        <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                            ...
                            <div class="card-body">
                                ...
                                <center><a href="add-employee.php" class="btn btn-sm btn-info">Add New Employee</a></center>
                                    ...
                                    <?php 
                                    // $sql = "SELECT EmpId,FirstName,LastName,Department,Status,RegDate,id from  employees";
                                    // $sql = "SELECT EmpId,FirstName,LastName,Department,Status,RegDate,id from  employees_views";
                                    $sql = "SELECT EmpId,FirstName,LastName,Department,Status,RegDate,id from  employees_view";
                                    $query = $dbh -> prepare($sql);
                                    $query->execute();
