<?php
    ...
    header('location:../index.php');
        ...
        $isread=0;
         ...
         if($fromdate > $todate) {
            $error = "Please enter correct details: FromDate must be before or equal to ToDate!";
        } else {
            // Proceed with database insertion
            $sql = "INSERT INTO leaves (LeaveType, ToDate, FromDate, Description, Status, IsRead, empid) VALUES (:leavetype, :todate, :fromdate, :description, :status, :isread, :empid)";
